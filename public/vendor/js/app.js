...
Vue.component('translation-input', __webpack_require__(33));
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-acc51d60", Component.options)
  } else {
    hotAPI.reload("data-v-acc51d60", Component.options)
  }
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: !_vm.isActive && !_vm.hasSaved && !_vm.hasErrored,
            expression: "!isActive && !hasSaved && !hasErrored"
          }
        ],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-acc51d60", module.exports)
  }
}
